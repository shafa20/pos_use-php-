                                    ...
                                    if ($employee->num_rows>0) {
                                        while ($data = $employee->fetch_assoc()){ ?>
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="emp_show.php?id=<?php echo $data['em_id'] ?>" class="btn btn-sm btn-primary">Show</a>
                                                    <a href="emp_edit.php?id=<?php echo $data['em_id'] ?>" class="btn btn-sm btn-info">Edit</a>
