                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header d-flex bg-info">
                            <h4 class="text-uppercase">All Comapany</h4>
                            <a href="company_create.php" class="btn btn-sm btn-primary ml-auto"><i class="fas fa-plus"></i> Add Comapany</a>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                                ...
                                <?php 
                                    ...
                                    if ($company->num_rows>0) {
                                        while ($data = $company->fetch_assoc()){ ?>
                                            <tr>
                                                <td><?php echo $sl++ ?></td>
                                                <td><?php echo $data['company_branch'] ?></td>
